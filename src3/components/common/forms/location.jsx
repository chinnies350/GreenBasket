...
class Location extends PureComponent {
  ...
  //   // if(this.state.errorMsg == "Delivery not available at this location"){
  //   //   await this.setState({ configName: "" });
    // }
  // }
  ...
  render() {
    ...
    return (
      ...
      //               {isHidden && configName !== "" &&errorMsg!="Delivery not available at this location" && configName.length>=6&& <span className="text-success">Delivery available</span>}
