...
class AddProduct extends PureComponent {
  ...
  formStateCheck = async (data) => {
    ...
    await this.setState({ data, productId: data.productId,ImageUrl:data.productImage });
    try {
  ...
  schema = {
    ...
    productUom: Joi.number().required().label("productUom"),
  ...
  fileUpload = (file) => {
    const url = "http://192.168.1.22:5500/uploadImage";
        ...
        <Form getApi={this.setFormApi} onSubmit={this.onSubmit}>
          {({ formApi, formState }) => (
            <div>
              ...
              <Row className="form-div">
                ...
                {/* <Col md={3} sm={12}>
                  <CustomRadio
                    ...
                    label="Best Selling"
                    name="bestSelling"
                    options={this.state.bestSelling}
                    validateOnBlur
                    validate={(e) => this.validateProperty("bestSelling", e)}
                  />
                </Col> */}
                <Col md={3} sm={12}>
                  <Input
              ...
              <ImageView label="productImage" src={ImageUrl} alt="hello" />
                <Col md={12} sm={12}>
                  <Textarea
                    field="description"
                    label="Description"
