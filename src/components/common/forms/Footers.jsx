                  ...
                  <div className="row p-3">
                    <div className="col-sm-3 col-xs-12"><br />
                      ...
                      <div className="footer-text">
                        <p>Address : {data[0].addressLine1}</p>
                        <p>{data[0].addressLine2}</p>
                        <p>Phone : {data[0].contactNumber}</p>
                    ...
                    <div className="col-sm-2 col-xs-12"><br />
                      ...
                      <div className="footer-text" style={{ display: 'inline-grid', lineHeight: '2' }}>
                        {allCategories && allCategories.map((pageName) =>
                          <Link to={`${subDirectory}/user/${pageName.categoryName.toLowerCase().replace(" ", "-")} `} id="alinkcolor1" onClick={() => onClick(pageName['categoryId'])} exact="true">{pageName.categoryName} </Link>
                        )}
                      </div>
                    </div>
                    <div className="col-sm-2 col-xs-12"><br />
