...
class HomeSettings extends PureComponent {
  ...
  /**
   * Get the previous information from server
   */
  getHomeConfig = async () => {
    let merchantId = getCookieData("MERID")
    try {
      const res = await getHomeConfig(merchantId);
      console.log(res)
  ...
  /**
   * On drop this function will fire the event
   */
  onDrop = (files = []) => {
  ...
  /**
   * It was used to preview the image while upload 
   */
  ...
  /**
   * When user click the edit button it will open the form and patch the values
   */
  editInfo = async (id) => {
  ...
  /**
   * Handle submit to playing the main a main role in this area
   */
  handleSubmit = async () => {
  ...
  /**
   * This function to send a file to server and return a response in a web hosted url
   */
  ...
  fileUpload = async () => {
    try {
      ...
      const url = `http://mean.prematix.solutions/paypre_retail/uploadImage`
        ...
        {isFormHidden && !isLoading && <Container className="mycard  mt-3" style={{ zIndex: 1 }}>
          <Row>
            <Col sm={4} className="borderright">
              ...
              <img src={homeData[0]["imageUrl"]} alt="images" className="img-fluid" />
            ...
            <Col sm={4} className="borderright">
              ...
              <img src={homeData[1]["imageUrl"]} alt="images" className="img-fluid" />
            ...
            <Col sm={4}>
              ...
              <img src={homeData[2]["imageUrl"]} alt="images" className="img-fluid" />
