...
import { getProductsbyId1, getCategorybyId } from 'service/dashboardService';
import { getCookieData } from "../common/CookiesFunc";
...
class User extends PureComponent {
  ...
  getProducts = async (categoryId) => {
    let params = `categoryId=${categoryId}&merchantId=${this.state.merchantd}`;
    let res = await getProductsbyId1(params)
  ...
  frameLoad = () => {
    ...
    switch (pageName) {
      ...
      default:
        return <UserDashboard props={this.props} data={searchData} />
    }
  }
  /**
  ...
  searchProdItems = async (term) => {
    ...
    var { data: { data } } = res;
    var searchData = data === "no data" ? data = [] : data
