...
export default class ProductDetails extends PureComponent {
    ...
    actionsFormatter = (cell, row, rowIndex, formatExtraData) => {
        let links = [];
        links.push(<InoIcons.IoIosEye title="View" onClick={() => this.viewFun(`${subDirectory}/dashboard/view-product-status`, row)} />)
        return <div className="actions">{links.concat(" ")}</div>
    }
    ...
    render() {
        ...
        const breadCrumbItems = {
            ...
            items: [
                ...
                { name: "Dashboard", active: false, link: `${subDirectory}/dashboard` },
