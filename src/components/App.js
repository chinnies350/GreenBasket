...
import MerchantRouting from "../components/common/MerchantRouting";
        ...
        <BrowserRouter basename="/easyfruitveg">
          <Router>
            {isWrapper && !isUser && isLogedIn && (
              <Wrapper userRole={userRole} {...this.props} />
            )}
            {!isWrapper && (
              <Switch>

                <Route path={`${subDirectory}/Routing`}  component={MerchantRouting} />
